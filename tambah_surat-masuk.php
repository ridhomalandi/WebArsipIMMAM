...
move_uploaded_file($_FILES['file']['tmp_name'], $direktori.$file);
    ...
    $query  = "INSERT INTO surat_masuk VALUES ('','$tanggal_masuk', '$no_surat', '$pengirim_surat', '$perihal_surat','$keterangan_surat', '$file')";
...
<div class="mb-3">
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" name= "pengirim_surat" id="pengirim_surat" required>
  </div>
  <div class="mb-3">
