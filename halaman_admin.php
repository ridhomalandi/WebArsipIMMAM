...
<html lang="en">
  ...
  <?php 
    ...
    <!--fixed-top berfungsi untuk agar navbar tidak ikut ke-scroll -->
        <div class="container">
      ...
      <section class="jumbotron text-center ">
        ...
        <p class="lead mx-5">Sistem Informasi Arsip (E-Arsip) IMM Adam Malik adalah sistem yang digunakan untuk menyimpan data-data penting guna memudahkan dalam
          menjalankan administrasi didalam Organisasi itu sendiriSistem ini sendiri dikelola oleh Sekretaris Umum dan Sekrtaris Bidang selaku penanggungjawab administrasi
      ...
      <section id='menuarsip'>
        <div class="container">
          ...
          <div class="row pt-5 text-center">
            ...
            <div class="col-md-3 mb-3">
              <div class="figure" >
                <img src="img/inventaris.png" width='150' alt="menu">
                <div class="card-body">
                  <h5 class="card-title">Inventaris</h5>
                  <p class="card-text">Silahkan masukkan data inventaris pada menu ini</p>
                  <a href="halaman_inventaris.php" class="btn btn-primary" >Selengkapnya</a>
                </div>
              </div>
            </div>
            <div class="col-md-3 mb-3">
              <div class="figure" >
                ...
                <div class="card-body">
                  ...
                  <p class="card-text">Silahkan masukkan data buku organisasi pada menu ini</p>
      ...
      <section id="pengaturan">
        ...
        <div class="col mb-1" >
          <div class="row g-0">
            <div class="col-3">
              <img src="img/setting.png" width= '250'  alt="setting">
            </div>
            <div class="col-md-8">
              <div class="card-body pt-5">
                <h5 class="card-title">Pengaturan</h5>
                <p class="card-text">Menu yang digunakan untuk mengatur akun pengguna</p>
                <a href="halaman_pengaturan.php" class="btn btn-primary" >Selengkapnya</a>
              </div>
            </div>
          </div>
        </div>
