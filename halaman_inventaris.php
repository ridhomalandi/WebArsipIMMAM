<?php
include 'koneksi.php';
$query  = mysqli_query ($koneksi, "SELECT *FROM tabel_inventaris ORDER BY id ASC");
...
<h1 class="display-4 fw-bold text-primary">DATA BARANG</h1>
<a href="tambahbarang_inventaris.php" class="btn btn-primary btn-sm mb-1">+ Tambah Barang</a>
...
<tbody>
        ...
        <tr>
            ...
            <td>
            <a href="hapusbarang_inventaris.php?id=<?php echo $data['id']; ?>"class="btn btn-primary">Hapus</a> 
            <a href="ubahbarang_inventaris.php?id=<?php echo $data['id']; ?>" class="btn btn-primary ">Update</a>
            </td>
        </tr>
        <?php $no++; } ?>
        <?php } ?>
