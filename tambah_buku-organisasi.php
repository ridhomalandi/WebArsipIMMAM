...
if (isset ($_POST["submit"])){
    ...
    $judul_buku = htmlspecialchars (addslashes ( $_POST["judul_buku"]));
    $genre_buku = htmlspecialchars ($_POST["genre_buku"]);
    $pengarang_buku = htmlspecialchars (addslashes($_POST["pengarang_buku"]));
    $penerbit_buku =htmlspecialchars ( addslashes($_POST["penerbit_buku"]));
    $kategorisasi =htmlspecialchars ( $_POST["kategorisasi"]);

    $query  = "INSERT INTO buku_organisasi VALUES ('','$judul_buku', '$genre_buku', '$pengarang_buku', '$penerbit_buku','$kategorisasi')";
...
<div class="mb-3">
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" name="genre_buku" id="genre_buku" required>
  </div>
  <div class="mb-3">
    <label for="pengarang_buku" class="form-label">Pengarang</label>
    <input type="text" class="form-control" name= "pengarang_buku" id="pengarang_buku" required>
  </div>
  <div class="mb-3">
    <label for="penerbit_buku" class="form-label">Penerbit</label>
    <input type="text" class="form-control" name= "penerbit_buku" id="penerbit_buku" required>
  </div>
  <div class="mb-3">
    <label for="kategorisasi" class="form-label">Kategorisasi</label>
    <input type="text" class="form-control" name= "kategorisasi" id="kategorisasi" required>
  </div>
