<?php
include 'koneksi.php';
$query  = mysqli_query ($koneksi, "SELECT *FROM surat_keluar ORDER BY id ASC");
...
<h1 class="display-4 fw-bold text-primary">DATA SURAT KELUAR</h1>
<a href="tambah_surat-keluar.php" class="btn btn-primary btn-sm mb-1">+ Tambah Surat</a>
...
<tbody>
        ...
        <tr>
            ...
            <td><a href="file/<?php echo $data['file'];?>"><!--<?php echo $data["file"];?>-->Download File</a></td>
            <td>
            <a href="hapus_surat-keluar.php?id=<?php echo $data['id']; ?>"class="btn btn-primary">Hapus</a> 
            <a href="ubahdata_surat-keluar.php?id=<?php echo $data['id']; ?>" class="btn btn-primary ">Update</a>
            </td>
        </tr>
        <?php $no++; } ?>
        <?php } ?>
