<?php
include 'koneksi.php';
$query  = mysqli_query ($koneksi, "SELECT *FROM buku_organisasi ORDER BY kategorisasi ASC");
...
<h1 class="display-4 fw-bold text-primary">DATA BUKU ORGANISASI</h1>
<a href="tambah_buku-organisasi.php" class="btn btn-primary btn-sm mb-1">+ Tambah</a>
...
<tbody>
        ...
        <tr>
            ...
            <td><?php echo $data["kategorisasi"];?></td>
            <td>
            <a href="hapus_buku-organisasi.php?id=<?php echo $data['id']; ?>"class="btn btn-primary">Hapus</a> 
            <a href="ubahdata_buku-organisasi.php?id=<?php echo $data['id']; ?>" class="btn btn-primary ">Update</a>
            </td>
        </tr>
        <?php $no++; } ?>
        <?php } ?>
