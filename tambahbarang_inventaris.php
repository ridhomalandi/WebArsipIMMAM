...
if (isset ($_POST["submit"])){
    ...
    $query  = "INSERT INTO tabel_inventaris VALUES ('','$nama_barang', '$jumlah_barang', '$satuan_barang', '$keterangan_barang')";
...
<div class="mb-3">
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" name= "satuan_barang" id="satuan_barang" required>
  </div>
  <div class="mb-3">
    <label for="keterangan_barang" class="form-label">Keterangan</label>
    <input type="text" class="form-control" name= "keterangan_barang" id="keterangan_barang" required>
  </div>
