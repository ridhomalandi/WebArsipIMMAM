...
move_uploaded_file($_FILES['file']['tmp_name'], $direktori.$file);
    ...
    $query  = "INSERT INTO surat_keluar VALUES ('','$no_surat', '$tanggal_keluar', '$perihal_surat', '$tujuan_surat','$keterangan_surat','$file')";
...
<div class="mb-3">
  ...
  <div class="mb-3">
    <label for="tanggal_keluar" class="form-label">Tanggal Surat</label>
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" name= "perihal_surat" id="perihal_surat" required>
  </div>
  <div class="mb-3">
    <label for="tujuan_surat" class="form-label">Tujuan</label>
    <input type="text" class="form-control" name= "tujuan_surat" id="tujuan_surat" required>
  </div>
  <div class="mb-3">
    <label for="keterangan_surat" class="form-label">Keterangan</label>
    <input type="text" class="form-control" name= "keterangan_surat" id="keterangan_surat" required>
  </div>
  <div class="mb-3">
