...
$id=$_GET['id'];
$surat = mysqli_fetch_array(mysqli_query($koneksi, "SELECT * FROM surat_keluar WHERE id=$id"));
...
<div class="mb-3">
  ...
  <div class="mb-3">
    ...
    <input type="date" class="form-control" name="tanggal_keluar" id="tanggal_keluar" required value="<?= $surat['tanggal_keluar']?>">
  </div>
  <div class="mb-3">
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" name= "tujuan_surat" id="tujuan_surat" required value="<?= $surat['tujuan_surat']?>">
  </div>
  <div class="mb-3">
